using me.cqp.luohuaming.WordCloud.Tool.IniConfig.Attribute;
using me.cqp.luohuaming.WordCloud.Tool.IniConfig.Exception;
...
namespace me.cqp.luohuaming.WordCloud.Tool.IniConfig
{
	/// <summary>
