...
{
    public class DrawPersonalAnyYearCloud : IOrderModel
    {
        public bool ImplementFlag { get; set; } = true;

        public string GetOrderStr() => CloudConfig.PersonalAnyYearCloudOrder;
        ...
        public FunctionResult Progress(CQGroupMessageEventArgs e)//群聊处理
        {
            ...
            string capture = Regex.Match(e.Message.Text, GetOrderStr()).Groups[1].Value;
            DateTime dt = new DateTime(int.Parse(capture), 1, 1);
