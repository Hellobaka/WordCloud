...
namespace me.cqp.luohuaming.WordCloud.Code.OrderFunctions
{
    public class DrawPersonalLastYearCloud : IOrderModel
    {
        ...
        public string GetOrderStr() => CloudConfig.PersonalYearOrder;
        ...
        public FunctionResult Progress(CQGroupMessageEventArgs e)//群聊处理
        {
            ...
            string statistics = $"{e.FromQQ.CQCode_At()}统计时段: {dt.ToString("G").Replace(" 0:00:00", "")}-{DateTime.Now.ToString("G").Replace(" 0:00:00", "")}，共计: {drawResult.WordNum}个词汇";
