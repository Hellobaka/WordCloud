...
using me.cqp.luohuaming.WordCloud.Core;
using me.cqp.luohuaming.WordCloud.Core.Domain;
using me.cqp.luohuaming.WordCloud.Sdk.Cqp;
using me.cqp.luohuaming.WordCloud.Sdk.Cqp.Enum;
...
namespace me.cqp.luohuaming.WordCloud.App.Export
{
	/// <summary>	
	/// 表示酷Q事件导出的类	
	/// </summary>	
	...
	{	
		...
		{	
			return "9,me.cqp.luohuaming.WordCloud";	
		}	
		...
		{	
			...
			Type appDataType = typeof (AppData);	
			// 注册一个 CQApi 实例	
			AppInfo appInfo = new AppInfo ("me.cqp.luohuaming.WordCloud", 1, 9, "水银词云机", "1.1.1", 1, "落花茗", "小词云插件", authCode);	
			...
			AppData.UnityContainer.RegisterInstance<CQLog> ("me.cqp.luohuaming.WordCloud", AppData.CQLog);	
